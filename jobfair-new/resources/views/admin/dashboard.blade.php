...
<html lang="en">
    ...
    <body id="page-top">
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">Admin JF</div>
                </a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Custom Job Vacancies:</h6>
                            <a class="collapse-item" href="{{ url('/companies') }}">Companies</a>
                            <a class="collapse-item" href="{{ url('/vacancies') }}">Vacancies</a>
                            <a class="collapse-item" href="{{ url('/applicant') }}">Applicant</a>
                        </div>
                    </div>
                </li>
        ...
        <script src="{{env('CDN_URL')}}admin/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
